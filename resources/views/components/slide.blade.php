<div class="slider-area an-1 hm-1">
    ...
    <div class="bend niceties preview-2">
        <div id="ensign-nivoslider" class="slides">
            <img src="{{ asset('images/banner/8.png') }}" alt="" title="#slider-direction-1"  />
            <img src="{{ asset('images/banner/9.jpg') }}" alt="" title="#slider-direction-2"  />
            <img src="{{ asset('images/banner/10.jpg') }}" alt="" title="#slider-direction-3"  />
        </div>
        <!-- direction 1 -->
