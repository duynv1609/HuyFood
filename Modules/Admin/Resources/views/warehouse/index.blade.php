...
@section('content')
    ...
    <div class="table-responsive">
        <h2>Quản lý sản phẩm <a href="?type=inventory" class="{{ Request::get('type') == "inventory" || !Request::get('type') ? "active" : "" }}">Hàng tồn </a>
            - <a href="?type=pay" class="{{ Request::get('type') == "pay" ? "active" : "" }}">Bán chạy</a>
        </h2>
